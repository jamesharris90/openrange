...
(async () => {
  try {
    ...
    assert.strictEqual(result.stats.signalLeaderboards, 7, 'expected seven signal leaderboards');
    ...
    assert.strictEqual(result.signalResults.length, 7, 'expected seven signal summaries');
